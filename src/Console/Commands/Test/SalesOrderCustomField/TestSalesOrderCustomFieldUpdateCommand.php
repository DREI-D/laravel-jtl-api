...
class TestSalesOrderCustomFieldUpdateCommand extends Command
{
    protected $signature = 'jtl-api:test:sales-order-custom-field-update';
    ...
    public function handle(): void
    {
        ...
        $response = app(SalesOrderCustomFieldRepository::class)->updateSalesOrderCustomField(
            new UpdateSalesOrderCustomFieldRequest(
                salesOrderId: $salesOrder->id,
