...
class TestItemCreateCommand extends Command
{
    protected $signature = 'jtl-api:test:item-create';

    protected $description = 'Tests the item create endpoint';
    ...
    {
        $response = app(ItemRepository::class)->createItem(
