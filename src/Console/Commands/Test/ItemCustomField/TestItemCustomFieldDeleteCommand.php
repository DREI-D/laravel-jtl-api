...
class TestItemCustomFieldDeleteCommand extends Command
{
    protected $signature = 'jtl-api:test:item-custom-field-delete';

    protected $description = 'Tests the item custom field delete endpoint';
    ...
    public function handle(): void
    {
        ...
        $response = app(ItemCustomFieldRepository::class)->deleteItemCustomField(
            new DeleteItemCustomFieldRequest(
                itemId: $item->id,
